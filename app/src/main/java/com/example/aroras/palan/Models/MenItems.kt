...
import com.example.aroras.palan.Activity.ItemMenDetails
...
data class MenItems(val Name:String,val Image:String,val Description:String,val Price:String,val Discount:String,val MenuId:String){


    constructor():this("","","","","","")
}

class MenItemsAdapter(val data:ArrayList<MenItems>): RecyclerView.Adapter<MenItemsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            var pos=(position+11).toString()
            val startAct = Intent(holder.itemView.context, ItemMenDetails::class.java)
            //get Item id
