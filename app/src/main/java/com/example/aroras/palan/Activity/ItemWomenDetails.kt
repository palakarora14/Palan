...
class ItemWomenDetails : AppCompatActivity() {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    for (i in p0.children) {
                        ...
                        if (i.key == newString) {
                            ...
                            val currentItem = i.getValue(WomenItems::class.java)
                            ...
                            btnCart.setOnClickListener {
                                ...
                                Toast.makeText(this@ItemWomenDetails,"Added to Cart",Toast.LENGTH_SHORT).show()
                            }
                        }
