...
class ItemMenDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_item_men_details)
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    for (i in p0.children) {
                        ...
                        if (i.key == newString) {
                            ...
                            val currentItem = i.getValue(MenItems::class.java)
                            ...
                            btnCart.setOnClickListener {
                                ...
                                Toast.makeText(this@ItemMenDetails,"Added to Cart",Toast.LENGTH_SHORT).show()
                            }
                        }
                    }
